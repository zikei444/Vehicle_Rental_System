...
@section('content')
    <div class="container my-5">
        ...
        @forelse($reservations as $reservation)
            <div class="card mb-3 shadow-sm rounded-4" id="reservation-{{ $reservation->id }}">
                ...
                <div class="card-body">
                    <p><strong>Vehicle:</strong> {{ $reservation->vehicle->brand ?? 'Unknown' }}
    ...
    <div class="modal" id="rateModal"
        style="display:none; position:fixed; top:20%; left:35%; width:30%; background:#fff; border-radius:15px; border:1px solid #ccc; padding:25px; z-index:1000; box-shadow: 0 5px 15px rgba(0,0,0,.3);">
